...
struct clip_init_result clip_init(const char * fname, struct clip_context_params ctx_params) {
    ...
    try {
        ...
        if (loader.has_vision) {
            ...
            // TODO: we don't support audio for Gemma 3N / 4, but GGUF contains audio tensors
            // we can remove this check when we implement audio support for them
...
private:
    // Bilinear resize function (upstream PR #21711 — crash fix for tiny / single-pixel images)
